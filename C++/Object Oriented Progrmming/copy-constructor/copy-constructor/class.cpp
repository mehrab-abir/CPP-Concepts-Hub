...
SuperHero::SuperHero(const SuperHero& other) {
	...
	this->age = other.age;
	/*
	other referes to the existing object(or source object), this->name refers to the new object that is being created from the existing/source object
	*/
...
Deep::Deep(const Deep& other) {
	...
	/*
	other referes to the existing object(or source object), this->data referes to the new object that is being created from the existing/source object
	*/
